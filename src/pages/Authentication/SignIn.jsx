...
import {checkToken, getUserDataFromToken, storeToken} from "@/utils/token/token.js";
...
export default function SignIn() {
    ...
    const {
        ...
        onSuccess: (data) => {
            ...
            storeToken(token);
            dispatch(userActions.setUser(getUserDataFromToken(token)));
            navigate("/home");
        },
    });
                ...
                <form className="flex flex-col justify-center gap-8 py-10 px-10 w-1/2">
                    ...
                    <div className="space-y-7">
                        ...
                        <Input
                            ...
                            hasError={isError}
                        />
                        {isError && <p className="text-red-500 text-sm text-center">{error?.message || "fallback error"}</p>}
                        <div className="flex flex-row justify-between">
                            ...
                            <a
                                href=""
                                className="text-lightPurple-500 font-sans font-medium text-sm flex"
                            >
                                Forgot Password?
                            </a>
                        </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="text-center font-sans font-light text-sm text-surface-900">
                            ...
                            <a
                                href="/auth/sign-up"
                                className="text-lightPurple-500 font-bold"
                            >
                                Sign up
                            </a>
                        </p>
